...
// scp solver_neopt.c mihaela.bercu@fep.grid.pub.ro:ASC/tema2/skel/solver_neopt.c
// scp solver_opt.c mihaela.bercu@fep.grid.pub.ro:ASC/tema2/skel/solver_opt.c   
// ./compare out1 /export/asc/tema2/out1 0.001
// qsub -cwd -q hp-sl.q -b y ./example_1
// qsub -cwd -q ibm-nehalem.q -b y ./tema2_blas input
